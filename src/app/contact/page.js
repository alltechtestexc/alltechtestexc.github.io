...
export default function Page() {
    ...
    return <div className={`h-full mx-auto items-center flex md:flex-row flex-col md:pt-0 pt-10`}>
        ...
        <h1 className="text-zinc-900 text-2xl mb-4 font-bold" dir="auto">{STRINGS.titles.contact[language]}</h1>
        ...
        <h1 className="text-zinc-900 text-3xl mb-4" style={{ fontFamily: "var(--font-heading)"}}>ליזה זברסקי</h1>
          </div>
