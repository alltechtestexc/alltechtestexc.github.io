    ...
    return <div className={`h-full mx-auto items-center flex md:flex-row flex-col md:pt-0 pt-10`}>
        <div className="flex-1 md:mr-12" >
            ...
            <div className="flex flex-row justify-between">
                ...
                <h1 className="text-zinc-900 text-3xl mb-4 text-right" style={{ fontFamily: "var(--font-heading) var(--font-hebrew)" }}>ליזה זברסקי</h1>
            </div>
            ...
            <div className="items-center flex flex-col">
                ...
                <div className={`flex ${language === "he" ? "flex-row-reverse" : "flex-row"}`}>
                    <h1 className="text-zinc-900 text-2xl mb-4" dir="auto">{STRINGS.misc.tel[language]}:</h1><h1 className="w-2">{" "}</h1><h1 className="text-zinc-900 text-2xl mb-4">+972 507393995</h1>
                </div>
